...
#import "XWRefreshNormalHeader.h"


@interface XWRefreshNormalHeader()
...
@implementation XWRefreshNormalHeader
#pragma mark - 重写方法
...
- (void)prepare
{
    ...
    _ttlayer = [ORMagicTextLayer layerWithText:@"JSHL" rect:rect];
